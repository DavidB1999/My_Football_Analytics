# all credit goes to Laurie Shaw
# https://github.com/Friends-of-Tracking-Data-FoTD/LaurieOnTracking
# https://youtu.be/8TrleFklEsE
...
"""
My changes will be made visible by comments! # - change -
"""
...
def to_metric_coordinates(data,field_dimen=(106.,68.), origin = 'bottom_left', in_place=False):
    '''
    ...
    if origin == 'center' or origin == 'centre':
        ...
        data[y_columns] = -1 *( data[y_columns]) * field_dimen[1] + field_dimen[1]
    else:
        raise ValueError(f'{origin} was selected for origin and is not a valid option. Choose either'
                         f'"bottom_left" or "center".')
    '''
    ------------ ***NOTE*** ------------
